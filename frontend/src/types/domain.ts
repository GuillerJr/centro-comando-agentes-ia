...
export type Agent = { id: string; name: string; description: string; agent_type: string; status: string; skill_ids: string[]; priority: number; execution_limit: number; communication_channel?: string | null; communication_channel_type?: string | null; communication_provider?: string | null; communication_target?: string | null; communication_mode?: string | null; communication_is_dedicated?: boolean | null; communication_reply_policy?: string | null; metadata?: Record<string, unknown>; last_activity_at?: string | null; created_at: string; };
...
export type Approval = { id: string; task_id?: string | null; approval_type: string; reason: string; requested_by: string; status: string; reviewed_by?: string | null; reviewed_at?: string | null; execution_notes?: string | null; payload_summary: Record<string, unknown>; mission_id?: string | null; mission_title?: string | null; mission_status?: string | null; task_title?: string | null; };
...
export type McpServer = { id: string; name: string; description: string; transport_type: string; endpoint?: string | null; status: string; permissions: string[]; allowed_actions: string[]; last_seen_at?: string | null; metadata?: Record<string, unknown>; };
...
export type WorkspaceMembership = { id: string; workspace_id: string; user_id: string; role_key: string; workspace_name: string; display_name: string; email: string; user_status: string; created_at: string; };
export type Workspace = { id: string; name: string; slug: string; description: string; status: string; member_count: number; owner_count: number; created_at: string; memberships?: WorkspaceMembership[]; };
