...
export type Agent = { id: string; name: string; description: string; agent_type: string; status: string; skill_ids: string[]; priority: number; execution_limit: number; last_activity_at?: string | null; created_at: string; };
export type Skill = { id: string; canonical_name: string; conversational_alias?: string | null; description: string; skill_type: string; status: string; when_to_use: string; when_not_to_use: string; related_skills: string[]; quality_checklist: string[]; };
export type Task = { id: string; title: string; description: string; priority: string; task_type: string; lead_skill_id?: string | null; support_skill_ids: string[]; status: string; result_summary?: string | null; logs?: string | null; created_at: string; started_at?: string | null; completed_at?: string | null; };
