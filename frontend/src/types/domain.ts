...
export type Agent = { id: string; name: string; description: string; agent_type: string; status: string; skill_ids: string[]; priority: number; execution_limit: number; communication_channel?: string | null; communication_channel_type?: string | null; metadata?: Record<string, unknown>; last_activity_at?: string | null; created_at: string; };
