...
INSERT INTO ai_agents (id, name, description, agent_type, status, skill_ids, priority, execution_limit, communication_channel, communication_channel_type, communication_provider, communication_target, communication_mode, communication_is_dedicated, communication_reply_policy, last_activity_at, metadata)
VALUES
('20000000-0000-0000-0000-000000000001', 'LokiClaw', 'Arquitecto-orquestador principal del centro de comando.', 'orchestrator', 'active', ARRAY['10000000-0000-0000-0000-000000000001'::uuid, '10000000-0000-0000-0000-000000000002'::uuid, '10000000-0000-0000-0000-000000000003'::uuid], 95, 10, 'telegram:guillerjr', 'telegram', 'telegram', 'telegram:1549350470', 'relay', FALSE, 'mission_control', NOW(), '{"owner":"Guiller"}'::jsonb),
('20000000-0000-0000-0000-000000000002', 'OpenClaw Runtime', 'Representación operativa del motor OpenClaw subyacente.', 'executor', 'active', ARRAY['10000000-0000-0000-0000-000000000005'::uuid], 90, 20, 'interno:openclaw-runtime', 'interno', 'interno', 'interno:openclaw-runtime', 'internal', TRUE, 'internal_only', NOW(), '{"mode":"local-gateway"}'::jsonb),
('20000000-0000-0000-0000-000000000003', 'Nora Review', 'Especialista en validación, auditoría y criterios de aprobación.', 'observer', 'active', ARRAY['10000000-0000-0000-0000-000000000001'::uuid, '10000000-0000-0000-0000-000000000004'::uuid], 82, 6, 'telegram:nora-review', 'telegram', 'telegram', 'telegram:@nora_review', 'direct', TRUE, 'same_channel', NOW(), '{"focus":"approval-flow"}'::jsonb),
('20000000-0000-0000-0000-000000000004', 'Iris UI', 'Especialista en experiencia visual y consistencia de interfaz.', 'specialist', 'active', ARRAY['10000000-0000-0000-0000-000000000005'::uuid], 78, 5, 'telegram:iris-ui', 'telegram', 'telegram', 'telegram:@iris_ui', 'direct', TRUE, 'same_channel', NOW(), '{"focus":"frontend"}'::jsonb),
('20000000-0000-0000-0000-000000000005', 'Atlas Data', 'Especialista en contratos backend, persistencia y consultas SQL.', 'specialist', 'active', ARRAY['10000000-0000-0000-0000-000000000004'::uuid, '10000000-0000-0000-0000-000000000005'::uuid], 84, 5, 'telegram:atlas-data', 'telegram', 'telegram', 'telegram:@atlas_data', 'direct', TRUE, 'same_channel', NOW(), '{"focus":"backend-database"}'::jsonb)
ON CONFLICT (id) DO NOTHING;
